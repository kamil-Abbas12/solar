...
export default function Hero() {
  return (
    <section id="hero" className="relative overflow-hidden bg-background scroll-mt-24">
      <div className="absolute -left-16 top-10 h-56 w-56 rounded-full bg-brand-soft blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-content items-center gap-10 px-6 py-16 md:grid-cols-2 md:gap-8 md:py-24 lg:py-28">
        <div className="relative z-10">
          ...
          <h1 className="text-3xl font-extrabold leading-tight text-ink sm:text-4xl md:text-5xl lg:text-6xl">
            Precision Solar Solutions{" "}
            <span className="text-brand">Designed to Scale Your Growth</span>
          </h1>
        ...
        <div className="relative order-first h-64 w-full overflow-hidden rounded-[2rem] border border-line shadow-xl sm:h-80 md:order-last md:h-96 lg:h-[440px]">
          <Image
            src="/solar.png"
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/10 via-transparent to-transparent md:bg-gradient-to-r md:from-black/10 md:via-transparent md:to-transparent" />
        </div>
      </div>
    </section>
  );
